 ...
 * @subpackage test
 */
class Test_CopixCookieObject extends CopixTest {
	...
	public function testDAOAuto (){
		$element = new CopixCookieObject ($dao = _ioDAO ('testautodao'), 'testautodao');
	...
	public function testDAOXML (){
		$element = new CopixCookieObject ($dao = _ioDAO ('testmain'));
		$element->findAll ();//appel d'une méthode pour vérifier le pont
		...
		$element = new CopixCookieObject ($dao = _ioDAO ('testmain'), 'test|testmain');
		$element->findAll ();//appel d'une méthode pour vérifier le pont
	...
	public function testRecordDAOAuto (){
		$element = new CopixCookieObject ($record = _record ('testautodao'), 'testautodao');
	...
	public function testRecordDAOXML (){
		$element = new CopixCookieObject ($record = _record ('testmain'));
		...
		//--- Même chose en spécifiant le qualificateur
		$element = new CopixCookieObject ($record = _record ('testmain'), 'test|testmain');
	...
	public function testClassWithSelector (){
		$element = new CopixCookieObject ($object = _ioClass ('fooclass'), 'test|fooclass');
	...
	public function testObject (){
		$element = new CopixCookieObject ($object = _ioClass ('fooclass'), CopixModule::getPath ('test').'classes/fooclass.class.php');
