 ...
 * @subpackage test
 */
class Test_CopixDateTimeTest extends CopixTest {
	function testToXXXX (){
	...
	function testToText (){
		CopixI18N::setLang ('fr');
		$this->assertEquals ('Samedi 25 Décembre 1976', CopixDateTime::yyyymmddToText ('19761225'));
		CopixI18N::setLang ('en');
	...
	function testDateDiff (){
		$arDate = array ("01/01/1970"=>"01/01/1970", "01/01/1970" => "01/01/1971" );
	}
	
	function testDateTime (){
		$this->assertFalse (CopixDateTime::DateTimeToyyyymmddhhiiss ('01/02/2003 tomates!'));
	}
}