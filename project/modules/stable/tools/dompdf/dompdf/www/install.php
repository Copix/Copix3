...
<h2>On this page:</h2>
<ul>
	<li><?php echo li_arrow() ?><a href="#requirements">Requirements</a></li>
	<li><?php echo li_arrow() ?><a href="#installation">Installation</a></li>
	<li><?php echo li_arrow() ?><a href="#fonts">Font Installation</a></li>
	<ul>
		<li><?php echo li_arrow() ?><a href="#all_platforms">Note for all platforms</a></li>
		<li><?php echo li_arrow() ?><a href="#unix">Linux/Unix</a></li>
		<ul>
			<li><?php echo li_arrow() ?><a href="#load_font"><pre>load_font.php</pre></a></li>
		</ul>
		<li><?php echo li_arrow() ?><a href="#windows">Windows</a></li>
	</ul>
	<li><?php echo li_arrow() ?><a href="#hacking">Hacking</a></li>
</ul>
</div>
