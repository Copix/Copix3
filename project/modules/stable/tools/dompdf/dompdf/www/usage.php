...
<h2>On this page:</h2>
<ul>
	<li><?php echo li_arrow() ?><a href="#usage">Usage</a></li>
	<ul>
		<li><?php echo li_arrow() ?><a href="#web">Invoking via the web</a></li>
    	<li><?php echo li_arrow() ?><a href="#cli">Invoking via the command line</a></li>
    	<li><?php echo li_arrow() ?><a href="#class">Using the dompdf class directly</a></li>
    	<li><?php echo li_arrow() ?><a href="#method_summary">dompdf class reference</a></li> 
	</ul>
	<li><?php echo li_arrow() ?><a href="#inline">Inline PHP support</a></li>
</ul>
</div>
...
<ul class="method-summary">
	<li><?php echo li_arrow() ?><span class="method-result">DOMPDF</span> <a href="#method__construct">__construct</a>()</li>
	<li><?php echo li_arrow() ?><span class="method-result">string</span> <a href="#methodget_base_path">get_base_path</a>()</li>
	<li><?php echo li_arrow() ?><span class="method-result">string</span> <a href="#methodget_host">get_host</a>()</li>
	<li><?php echo li_arrow() ?><span class="method-result">string</span> <a href="#methodget_protocol">get_protocol</a>()</li>
	<li><?php echo li_arrow() ?><span class="method-result">Frame_Tree</span> <a href="#methodget_tree">get_tree</a>()</li>
	<li><?php echo li_arrow() ?><span class="method-result">void</span> <a href="#methodload_html">load_html</a>(<span class="var-type">string</span> <span class="var-name">$str</span>)</li>
	<li><?php echo li_arrow() ?><span class="method-result">void</span> <a href="#methodload_html_file">load_html_file</a>(<span class="var-type">string</span> <span class="var-name">$file</span>)</li>
	<li><?php echo li_arrow() ?><span class="method-result">string</span> <a href="#methodoutput">output</a>()</li>
	<li><?php echo li_arrow() ?><span class="method-result">void</span> <a href="#methodrender">render</a>()</li>
	<li><?php echo li_arrow() ?><span class="method-result">void</span> <a href="#methodset_base_path">set_base_path</a>(<span class="var-type">string</span> <span class="var-name">$path</span>)</li>
	<li><?php echo li_arrow() ?><span class="method-result">void</span> <a href="#methodset_host">set_host</a>(<span class="var-type">string</span> <span class="var-name">$host</span>)</li>
	<li><?php echo li_arrow() ?><span class="method-result">void</span> <a href="#methodset_paper">set_paper</a>(<span class="var-type">string</span> <span class="var-name">$size</span>, [<span class="var-type">string</span> <span class="var-name">$orientation</span> = "portrait"])</li>
	<li><?php echo li_arrow() ?><span class="method-result">void</span> <a href="#methodset_protocol">set_protocol</a>(<span class="var-type">string</span> <span class="var-name">$proto</span>)</li>
	<li><?php echo li_arrow() ?><span class="method-result">void</span> <a href="#methodstream">stream</a>(<span class="var-type">string</span> <span class="var-type">$filename</span>, [<span class="var-type">mixed</span> <span class="var-name">$options</span> = null])</li>
</ul>
