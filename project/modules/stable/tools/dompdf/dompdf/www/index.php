...
<h2>On this page:</h2>
<ul>
	<li><?php echo li_arrow() ?><a href="#overview">Overview</a></li>
	<li><?php echo li_arrow() ?><a href="#features">Features</a></li>
	<li><?php echo li_arrow() ?><a href="#limitations">Limitations</a></li>
