 ...
 * Last Modified: $Date: 2007-06-23 16:08:23 $
 *
...
$language_data = array (
	...
	'KEYWORDS' => array(
		...
		2 => array(
			...
			'true', 'var', 'default',
			'function', 'class', 'new', '&amp;new', 'extends', 'private', 'protected', 'public', 'interface', 'implements', 'static',
		...
		3 => array(
			...
			'acos','abs','_','echo', 'print', 'global', 'exit', 'array', 'empty',
