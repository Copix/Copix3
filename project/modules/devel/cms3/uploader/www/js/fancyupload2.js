...
var FancyUpload2 = new Class({
	...
	onOpen: function(file, overall) {
		...
		this.currentTitle.set('html', 'Fichier "{name}"'.substitute(file) );
	},
	...
	onComplete: function(file, response) {
		...
		this.currentText.set('html', 'Envoi terminé !');
	...
	updateOverall: function(bytesTotal) {
		...
		this.overallTitle.set('html', 'Progression générale (' + this.sizeToKB(bytesTotal) + ')');
	},
