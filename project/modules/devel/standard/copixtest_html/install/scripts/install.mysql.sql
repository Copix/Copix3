CREATE TABLE IF NOT EXISTS `copixtesthtml` (
...
CREATE TABLE IF NOT EXISTS `copixtesthtmlsession` (
...
CREATE TABLE IF NOT EXISTS `copixtesthtmlbody` (
  `id_test` int(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `copixtesthtmlheader` (
  `id_test` int(20) NOT NULL,
  `id_mark` int(10) NOT NULL,
  `value_mark` varchar(512) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `copixtesthtmldomain` (
