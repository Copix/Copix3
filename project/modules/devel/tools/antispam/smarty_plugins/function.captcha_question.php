 ...
 */
function smarty_function_captcha_question($params, & $me) {
	if (isset ($params['assign'])){
		$assignVar = $params['assign'];
		unset ($params['assign']);
		$me->assign ($assignVar, _tag ('spinbutton|captcha_picture', $params));
		return;
	}else{
		return _tag ('spinbutton|captcha_picture', $params);
	}
}
