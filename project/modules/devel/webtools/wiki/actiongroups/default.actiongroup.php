...
class ActionGroupDefault extends CopixActionGroup {
    ...
    public function processShow () {
        ...
        // Récupération de la langue du site
        ...
        if (count($tr)){
            ...
            foreach ($tr as $translation){
                $translations .= '<a href="'._url ("wiki||show", array('title'=>$translation->title_wiki,'lang'=>$translation->lang_wiki,'heading'=>$translation->heading_wiki)).'"><img src="'._resource ('img/flags/'.$translation->lang_wiki.'.png').'" alt="'.$translation->lang_wiki.'"/></a> ';
            }
            $translations.="</div>\n";
        }
