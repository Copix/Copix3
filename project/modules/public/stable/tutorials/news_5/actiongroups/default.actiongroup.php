...
class ActionGroupDefault extends CopixActionGroup {
	...
	public function beforeAction (){
		CopixAuth::getCurrentUser()->assertCredential ('module:Voir@news_5');
	}
	...
	public function processDefault (){
		...
		$ppo->arNews = _dao ('news_5')->findBy (_daoSp ()->orderBy (array ('date_news', 'DESC')));
		$ppo->writeEnabled = CopixAuth::getCurrentUser ()->testCredential ('module:Ecrire@news_5');
	...
	public function processShow (){
		...
		if (! ($news = _dao ('news_5')->get (_request ('id_news')))){
