...
class CopixTest_CopixDateTimeTest extends CopixTest {
	...
	function testToDateTime (){
		...
		$this->assertEquals('12/25/1976 03:00:00 pm',CopixDateTime::yyyymmddhhiissToDateTime('19761225150000'));
		$this->assertEquals('12/25/1976 10:00:00 am',CopixDateTime::yyyymmddhhiissToDateTime('19761225100000'));
	}
