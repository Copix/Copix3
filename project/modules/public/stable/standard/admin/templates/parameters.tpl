...
<table class="CopixTable">
   ...
   {/if}
      ...
      <tr {cycle values=',class="alternate"'}>
         ...
         <td colspan = "2">
         	<div>
				<form action="{copixurl dest=admin|parameters|valid choiceModule=$choiceModule idFirst=$choiceModule idSecond=$params.Name}"
					method="post">
					{if $params.Type == 'bool'}
	            	...
	            	<a href="{copixurl dest="admin|parameters|" choiceModule=$choiceModule}"><img style = "vertical-align: middle" src="{copixresource path="img/tools/cancel.png"}" title="{i18n key="copix:common.buttons.cancel"}" alt="{i18n key="copix:common.buttons.cancel"}" /></a>
	            </form>
         	</div>
         </td>
         {else}
