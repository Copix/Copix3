<style>
	...
	div#webBoxContainer .webBoxCol { float: left; position: relative; height: auto; vertical-align: top; margin: 4px;  border: 1px dotted #EEE; }
...
<!-- a title="Add new content" href="#TB_inline?inlineId=getchoices&height=500&width=800" class="smoothbox">test</a -->
<p style="padding: 5px; border: 1px solid #AAA">
<a href="<?php echo _url('moocms|admin|getboxes',array('height'=>550,'width'=>650)); ?>" title="Ajouter un moobox" class="smoothbox">Add box</a> - 
...
window.addEvent('domready',function(){
	...
	$$('div#webBoxContainer .webBoxCol').each(function (el){
