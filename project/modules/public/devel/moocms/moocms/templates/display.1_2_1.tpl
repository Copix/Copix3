...
<div id="webBoxContainer">
		<div class="webBoxCol" id="zone1" style="width: 100%">
			{$zone1}
		</div>
		<div class="webBoxCol" id="zone2" style="width: 49%">
			{$zone2}
		</div>
		<div class="webBoxCol" id="zone3" style="width: 49%">
			{$zone3}
		</div>
		<div class="webBoxCol" id="zone4" style="width: 100%">
			{$zone4}
		</div>
</div>