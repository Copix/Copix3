...
class ActionGroupDocumentAdmin extends CopixActionGroup {
    ...
    */
	function canPaste (){
		...
		if (CopixUserProfile::valueOf ($headingProfileServices->getPath($heading),
		'document') < PROFILE_CCV_WRITE) {
			return false;
		}

		//do we have write permissions on the cutted element ?
		if (CopixUserProfile::valueOf ($headingProfileServices->getPath($document->id_head),
		'document') < PROFILE_CCV_PUBLISH) {
			return false;
		}
		return true;
	}
    ...
    */
	function doCut () {
		...
		if (CopixUserProfile::valueOf ($servicesHeadings->getPath ($toCut->id_head), 'document') < PROFILE_CCV_WRITE) {
			return CopixActionGroup::process ('genericTools|Messages::getError',
    ...
    */
	...
	function getViewVersion () {
		...
		//check if the user has the rights
		$servicesHeadings = & CopixClassesFactory::getInstanceOf ('copixheadings|CopixProfileForHeadingServices');
		if (CopixUserProfile::valueOf ($servicesHeadings->getPath ($document->id_head), 'document') < PROFILE_CCV_WRITE) {
			return CopixActionGroup::process ('genericTools|Messages::getError',
			array ('message'=>CopixI18N::get ('document.error.notAnAuthorizedHead'),
	...
	function getOnlineDocument () {
		...
		//check if the user has the rights
		$servicesHeadings = & CopixClassesFactory::getInstanceOf ('copixheadings|CopixProfileForHeadingServices');
		if (CopixUserProfile::valueOf ($servicesHeadings->getPath ($this->vars['id_head']), 'document') < PROFILE_CCV_WRITE) {
			return CopixActionGroup::process ('genericTools|Messages::getError',
			array ('message'=>CopixI18N::get ('document.error.notAnAuthorizedHead'),
			'back'=>CopixUrl::get ('copixheadings|admin|',array('browse'=>'document','id_head'=>$this->vars['id_head']))));
		}
    ...
    */
	function doValid (){
		...
		//check if the user has the rights
		$servicesHeadings = & CopixClassesFactory::getInstanceOf ('copixheadings|CopixProfileForHeadingServices');
		$capability       = CopixUserProfile::valueOf ($servicesHeadings->getPath ($toValid->id_head), 'document');
    ...
    */
	function getEdit (){
		...
		$workflow         = & CopixClassesFactory::getInstanceOf ('copixheadings|workflow');
		$servicesHeadings = & CopixClassesFactory::getInstanceOf ('copixheadings|CopixProfileForHeadingServices');
		$capability       = CopixUserProfile::valueOf ($servicesHeadings->getPath ($toEdit->id_head), 'document');
    ...
    */
	function doPrepareEdit (){
		...
		//check if the user has the rights
		$servicesHeadings = & CopixClassesFactory::getInstanceOf ('copixheadings|CopixProfileForHeadingServices');
		if (CopixUserProfile::valueOf ($servicesHeadings->getPath ($toEdit->id_head), 'document') < PROFILE_CCV_WRITE) {
			return CopixActionGroup::process ('genericTools|Messages::getError',
			array ('message'=>CopixI18N::get ('document.error.notAnAuthorizedHead'),
			'back'=>CopixUrl::get ('copixheadings|admin|', array('browse'=>'document','id_head'=>$toEdit->id_head))));
		}
    ...
    */
	function doStatusPublish (){
		...
		//check if the user has the rights
		$servicesHeadings = & CopixClassesFactory::getInstanceOf ('copixheadings|CopixProfileForHeadingServices');
		if (CopixUserProfile::valueOf ($servicesHeadings->getPath ($document->id_head), 'document') < PROFILE_CCV_PUBLISH) {
			return CopixActionGroup::process ('genericTools|Messages::getError',
			array ('message'=>CopixI18N::get ('document.error.notAnAuthorizedHead'),
			'back'=>CopixUrl::get ('copixheadings|admin|', array('browse'=>'document','id_head'=>$document->id_head))));
		}
    ...
    */
	function doStatusValid (){
		...
		//check if the user has the rights
		$servicesHeadings = & CopixClassesFactory::getInstanceOf ('copixheadings|CopixProfileForHeadingServices');
		if (CopixUserProfile::valueOf ($servicesHeadings->getPath ($document->id_head), 'document') < PROFILE_CCV_VALID &&
		$document->status_doc == $workflow->getPublish ()) {
			return CopixActionGroup::process ('genericTools|Messages::getError',
			array ('message'=>CopixI18N::get ('document.error.notAnAuthorizedHead'),
			'back'=>CopixUrl::get ('copixheadings|admin|', array('browse'=>'document','id_head'=>$document->id_head))));
    ...
    */
	function doStatusRefuse (){
		...
		//check if the user has the rights
		$servicesHeadings = & CopixClassesFactory::getInstanceOf ('copixheadings|CopixProfileForHeadingServices');
		$capability       = CopixUserProfile::valueOf ($servicesHeadings->getPath ($document->id_head), 'document');
