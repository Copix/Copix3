...
class TemplateTagCalendar extends CopixTemplateTag {
   ...
   public function process ($pParams, $pContent=null){
	    ...
	    //name of the input.
   		...
   		$out.= "$('".$name."').makeDatePicker({value: '" .$value . "', format: '".$format."', language: '".$lang."', sizeday:".$sizeday.", beforeyear:".$beforeyear.", afteryear:".$afteryear.", duration:".$duration.", imageCalendar:".$image;
    	//class du calendrier.
   		if (!empty ($classe)){
			$out .= ', classe:"'.$classe.'"';
   		}
