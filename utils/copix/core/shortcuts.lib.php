 ...
 * @return string
 */
function _i18n ($pKey, $pArgs = null, $pLocale = null) {
	return CopixI18N::get ($pKey, $pArgs, $pLocale);
}
 ...
 */
function _ioClass ($pClassId, $pInstanceId = 'default', $pArgs = null){
	return CopixClassesFactory::getInstanceOf ($pClassId, $pInstanceId, $pArgs);
}
...
/**
 * Racourci pour la récupération d'un copixform
 *
 * @param string $id identifiant du formulaire
 * @return CopixForm un objet copixform
 */
function _form ($id, $pParams = array ()) {
	return CopixFormFactory::get ($id, $pParams);
}

/**
 * Racourci pour l'instanciation d'un copixfield
 *
 * @param string $pType le type de field
 * @param array $pParams Le tableau de paramètre
 * @param boolean $pAssert Exception si il n'existe pas
 * @return CopixField
 */
function _field ($pType, $pParams = array (), $pAssert = true) {
	return CopixFieldFactory::get ($pType, $pParams, $pAssert);
}

/**
 * Raccourcis pour la création d'un filtre
 *
 * @param string $pName   nom du filtre
 * @param array  $pParams options du filtre
 */
