  ...
  Implements: Options,
	...
	initialize: function(obj, options) {
		...
		this.calendar = new Element('div', { 
			'styles': { left: '-1000px', opacity: 0, position: 'absolute', top: '-1000px', zIndex: 2000 }
		...
		for (var i in obj) {
			var cal = {
				button: this.options.img ? new Element('img', { 'src': this.options.img }) : new Element('button', { 'type': 'button' }).set('text', 'Calendrier'),
				el: $(i),
				els: [],
				id: id++,
				month: d.getMonth(),
